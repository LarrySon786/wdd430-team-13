...
// Brandon REPORTING ON ITEMS Completed
// 1. Completed password hashing
// 2. Completed 3 base tables
// 3. Provided example statements of how to add / pull data from the tables

// *** DELETE AND UPDATE will still need to be completed
...
async function insertUser(firstName: string, lastName: string, email: string, password: string, accountType: string) {
...
async function insertProduct(name: string, description: string, price: number, imageUrl: string, userId: number,) {
    await sql`
...
async function insertReview(score: number, message: string, userId: number, productId: number) {
    await sql`
